...
class PlayState extends MusicBeatState
{
    ...
    public var effect = new MosaicEffect();
			...
			case 'stage':
				{
						defaultCamZoom = 0.88;
						curStage = 'hell';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('Hell_BG', 'shared'));
						bg.antialiasing = true;
				...
				case 'hell':
					...
					case 'suffer':
					{
						...
						defaultCamZoom = 0.88;
						curStage = 'suffer';
						sufferbg = new FlxSprite(-600, -200).loadGraphic(Paths.image('hellscape', 'shared'));
						sufferbg.antialiasing = true;
						sufferbg.scrollFactor.set(0.9, 0.9);
						...
						if (daNote.noteType == 1)
							{
								...
								strumLine.shader = effect.shader;
								sufferbg.shader = effect.shader;
								effectTween = FlxTween.num(MosaicEffect.DEFAULT_STRENGTH, 15, 2, {type: PINGPONG, onComplete: function poo(tween:FlxTween):Void {
